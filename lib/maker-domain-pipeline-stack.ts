 ...
 * 
 * Self-contained pipeline infrastructure for the maker-domain domain:
...
export interface MakerDomainPipelineStackProps extends cdk.StackProps {
  domain: string;
...
export class MakerDomainPipelineStack extends cdk.Stack {
  public readonly artifactBucket: s3.Bucket;

  constructor(scope: Construct, id: string, props: MakerDomainPipelineStackProps) {
